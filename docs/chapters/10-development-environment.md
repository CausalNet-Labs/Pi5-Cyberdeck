...
**Learning objectives:** Install and verify the full general-purpose development toolchain — Git, Docker, VS Code, and Python — as a working end-to-end workflow, ready for whatever project you point it at.  
...
The toolchain above is intentionally project-agnostic. Set up your own project the same way regardless of what it is:
...
- VERIFY BEFORE CUTTING: Replace <your-project-repo-url> and my-project with your actual repository URL and

project name — this build isn't tied to any specific framework or codebase, so nothing is assumed here.
...
Before considering software setup complete: edit a file in VS Code, commit and push it via Git over SSH, build and run a Docker container, and run a basic Python script inside your project's virtual environment — all without leaving the device. Chapter Summary

- The dev toolchain (Git, Python, Docker, VS Code) is installed and verified as one connected, general-purpose workflow, not isolated installs.

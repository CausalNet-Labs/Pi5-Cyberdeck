...
Beyond the panel-mount Ethernet in Section 13.2, consider whether your development or general networking workflow benefits from a wired connection for large repository, dataset, or model transfers versus relying on Wi-Fi — this is a workflow decision, not a hardware constraint, since the Pi 5 supports both natively.
